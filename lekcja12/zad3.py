# Z DataFrame'a uzyskanego w zadaniu 2 wyświetl 10 rekordów z największymi wartościami w
# kolumnie 'Num Voters'. Wyświetl również wykres słupkowy dla tych danych.
